...
const help_menu_items = {
    label: "Help", role: "help", submenu: [
        { label: "MoebiusXBIN Tutorial", id: "open_tutorial", click(item) { event.emit("open_tutorial"); } },
        { label: "Keyboard shortcut cheatsheet", id: "show_cheatsheet", click(item) { event.emit("show_cheatsheet"); } },
        { label: "MoebiusXBIN editor homepage", id: "xbin_tutorial", click(item) { electron.shell.openExternal("https://blog.glyphdrawing.club/moebius-ansi-and-ascii-art-editor-with-custom-font-support/"); } },
        { label: "ASCII & ANSI Art Tutorials at 16Colors", id: "16colorstutorials", click(item) { electron.shell.openExternal("https://16colo.rs/tags/content/tutorial"); } },
        ...
        { label: "Report Issue at GitHub", id: "show_issues", click(item) { electron.shell.openExternal("https://github.com/hlotvonen/moebius/issues"); } },
        { type: "separator" },
        { label: "Original Mœbius Homepage", id: "show_homepage", click(item) { electron.shell.openExternal("https://blocktronics.github.io/moebius/"); } },
        { label: "Original Mœbius at GitHub", id: "show_repo", click(item) { electron.shell.openExternal("https://github.com/blocktronics/moebius"); } },
        { type: "separator" },
...
function colors_menu_template(win) {
    return {
        ...
        submenu: [
            ...
            { type: "separator" },
            { label: "Reset to Default Palette", id: "reset_to_default_palette", click(item) { win.send("reset_to_default_palette"); } },
            { type: "separator" },
